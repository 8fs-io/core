...
class RAGClient:
    ...
    def store_document(self, doc_id: str, content: str, metadata: Dict[str, Any] = None) -> bool:
        ...
        # NOTE: Using placeholder embedding for demonstration purposes only
        # In production, embeddings should be generated using proper AI models
        # These uniform 0.1 values will not provide meaningful similarity results
        payload = {
            "id": doc_id,
            "embedding": [0.1] * 384,  # Demo placeholder - replace with real embeddings
            "metadata": metadata
        }
